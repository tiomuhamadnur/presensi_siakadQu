            ...
            <div class="row card-header">
                <div class="col-4 d-flex justify-content-start flex-column">
                    <h5 class="fw-bold py-3 mb-4">
                        <span class="text-muted fw-light"><a href="{{ route('teacher.course.score.index') }}">Matpel
                        ...
                        @endphp
                        <span class="text-muted fw-light"><a href="{{ route('teacher.course.student.index', ['class_id' => $classId]) }}">Siswa
        ...
        <div class="modal fade" id="modalUpdate" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('teacher.course.student.score.update') }}" method="POST">
                        @csrf
                        @method('PUT')
